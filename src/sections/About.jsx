    ...
    >
      ...
      <div className="flex flex-col justify-center items-start gap-8">
        ...
        <p
          data-aos="zoom-in"
          data-aos-delay="400"
          className="text-xl text-gray-900 dark:text-white text-justify"
        >
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga qui,
          nulla eligendi neque placeat amet? Quaerat, ullam accusantium cumque
          error placeat, ut sapiente dolor dicta expedita atque voluptates
          doloribus veniam.
        </p>
        <button
          className="bg-red-600 dark:bg-red-700 hover:bg-black dark:hover:bg-white dark:hover:text-black 
